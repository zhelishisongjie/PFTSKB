...
class Pftd(models.Model):
    ...
    Period_of_fluid_therapy1 = models.CharField(max_length=50, null=True, blank=True)
    ...
    Evidence_level = models.CharField(max_length=255, null=True, blank=True)
    strength_of_recommendation = models.CharField(max_length=255, null=True, blank=True)
